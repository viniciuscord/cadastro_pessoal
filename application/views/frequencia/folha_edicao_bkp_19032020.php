    ...
    <div class="box-body">
        <?php if(!empty($dados)){ ?>
            <table id="table-result" class="table table-striped">
                <thead>
                    <tr>
                        <th colspan="4" class="silver">Folha de Ponto <i class="glyphicon glyphicon-time"></i></th>
                    ...
                    <tr>
                        <th class="silver">Matrícula</th>
                        <th class="silver">Nome</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td class="td-default"><?= $row['Matricula']; ?></td>
                            <td class="td-default"><?= $row['Nome']; ?></td>
        ...
        <div class="pull-right" style="padding: 15px;"><button class="btn btn-success" id="salvar" data-toggle="tooltip" style="cursor:pointer;" title="Salvar a folha do mês"><span class="fa fa-floppy-o"></span> Salvar Folha</button></div>
