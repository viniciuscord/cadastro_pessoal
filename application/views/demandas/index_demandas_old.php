                                ...
                                foreach ($demandas_por_funcionario as $key => $value) {
                                    ...
                                    ?>
                                        <li class="<?= substr($tipo_funcao[3],0,-1);?>">
                                            <img src="<?php echo base_url('images/no_image_user.png');?>" alt="User Image"
                                                width="50" height="50">
                      ...
                      foreach ($demandas_por_funcionario as $key => $value) {
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td class="align-tabela-td align-tabela"><?= $value['TOTALHORASMES']?></td>
                                    <td class="align-tabela-td align-tabela"><?= $value['TOTAL']?></td>
                                    <td class="align-tabela-td align-tabela"><?= $value['HEXTRA']?></td>
                                    <td class="align-tabela-td align-tabela"><?= $value['HNEGATIVA']?></td>
