                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" id="coordenador_modal" name="coordenador_modal">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control input-sm" id="superior_modal" name="superior_modal">
                                    <option value="" >Selecione o empregado</option> 
                                </select>
