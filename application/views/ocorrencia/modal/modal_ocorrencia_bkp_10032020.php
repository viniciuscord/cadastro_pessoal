                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="input-group"> 
                            ...
                            <select class="form-control input-sm" id="nome_modal" name="nome_modal" <?php if(isset($dados)) echo "readonly"; ?> >
                                <?php if(isset($dados)): ?>
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <?php if(isset($dados)): ?>
                                <select class="form-control input-sm" id="tipo_ocorr" name="tipo_ocorr" <?php if(isset($dados)) echo "readonly"; ?> >
                                    <option value="<?= $dados['IdTipoOcorrencia'];?>" ><?php if($dados['IdTipoOcorrencia'] == 1) echo "PONTO"; else echo "ADMINISTRATIVA" ?></option>
                                </select>
                            <?php else: ?>
                            <select class="form-control input-sm" id="tipo_ocorr" name="tipo_ocorr">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            ...
                            <select class="form-control input-sm" id="motivo_ocorr" name="motivo_ocorr" <?php if(isset($dados)) echo "readonly"; ?> >
                                <?php if(!isset($dados)): ?>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-sm datetimepicker date-mask" id="input-data-ini" name="input-data-ini" value="<?php if(isset($dados)) echo date('d/m/Y',strtotime($dados['DataInicio'])); ?>"   >     
                            </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-sm datetimepicker date-mask" id="input-data-fim" name="input-data-fim" value="<?php if(isset($dados)) echo date('d/m/Y',strtotime($dados['DataFim'])); ?>"   >     
                            </div>
