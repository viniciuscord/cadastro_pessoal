...
<script type="text/javascript" src="<?php echo base_url("js/admin-lte.js");?>"></script>
<script type="text/javascript" src="<?php echo base_url("js/modernizr.js");?>"></script>
<script type="text/javascript" src="<?php echo base_url("js/slimscroll.js");?>"></script>
<script type="text/javascript" src="<?php echo base_url("js/moment.js");?>"></script>
<script type="text/javascript" src="<?php echo base_url("js/toastr.js");?>"></script>	
<script type="text/javascript" src="<?php echo base_url("js/pace.js");?>"></script>
...
<script type="text/javascript" src="<?php echo base_url("js/handsontable.full.min.js");?>"></script>
<script type="text/javascript" src="<?php echo base_url("js/sweet.js"); ?>"></script>
<script type="text/javascript" src="<?php echo base_url("js/bootstrap-multiselect.js");?>"></script>
<script type="text/javascript" src="<?php echo base_url("js/pqgrid.min.js");?>"></script>
